// Site Navigation not Homepage 2.0 - Updated September 11, 2026
function noop() { }
...
// (368:6) {#if logo.image && logo.image.url}
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(a2, "click", /*click_handler_3*/ ctx[17]),
					listen(a3, "click", /*click_handler_4*/ ctx[18]),
					listen(a4, "click", /*click_handler_5*/ ctx[19])
				];
...
function create_fragment(ctx) {
	...
	let t13;
	let a5;
	let t14_value = /*primary_cta*/ ctx[1].label + "";
	let t14;
	let t15;
	let button;
	let span2;
	...
	let mounted;
	let dispose;
	let if_block0 = /*unternehmensOpen*/ ctx[3] && create_if_block_3();
	let if_block1 = /*logo*/ ctx[0].image && /*logo*/ ctx[0].image.url && create_if_block_2(ctx);
	let if_block2 = /*studierendeOpen*/ ctx[4] && create_if_block_1();
	let if_block3 = /*menuOpen*/ ctx[2] && create_if_block(ctx);
	...
	return {
		...
		l(nodes) {
			...
			var a1_nodes = children(a1);
			t1 = claim_text(a1_nodes, "Für Unternehmen\n            ");
			...
			var a4_nodes = children(a4);
			t10 = claim_text(a4_nodes, "Für Studierende\n          ");
			...
			var a5_nodes = children(a5);
			t14 = claim_text(a5_nodes, t14_value);
			a5_nodes.forEach(detach);
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div0, "mouseenter", /*mouseenter_handler*/ ctx[10]),
					listen(div0, "mouseleave", /*mouseleave_handler*/ ctx[11]),
					listen(div4, "mouseenter", /*mouseenter_handler_1*/ ctx[12]),
					listen(div4, "mouseleave", /*mouseleave_handler_1*/ ctx[13]),
		...
		p(ctx, [dirty]) {
			if (!current || dirty & /*unternehmensOpen*/ 8) {
				toggle_class(span0, "open", /*unternehmensOpen*/ ctx[3]);
			}

			if (/*unternehmensOpen*/ ctx[3]) {
				if (if_block0) ; else {
			...
			if (!current || dirty & /*studierendeOpen*/ 16) {
				toggle_class(span1, "open", /*studierendeOpen*/ ctx[4]);
			}

			if (/*studierendeOpen*/ ctx[4]) {
				if (if_block2) ; else {
			...
			if ((!current || dirty & /*primary_cta*/ 2) && t14_value !== (t14_value = /*primary_cta*/ ctx[1].label + "")) set_data(t14, t14_value);
...
function instance($$self, $$props, $$invalidate) {
	...
	function closeDropdowns(e) {
		if (!e.target.closest('.dropdown-wrapper')) {
			$$invalidate(3, unternehmensOpen = false);
			$$invalidate(4, studierendeOpen = false);
		}
	}
	...
	const mouseenter_handler = () => {
		$$invalidate(3, unternehmensOpen = true);
		$$invalidate(4, studierendeOpen = false);
	};

	const mouseleave_handler = () => $$invalidate(3, unternehmensOpen = false);

	const mouseenter_handler_1 = () => {
		$$invalidate(4, studierendeOpen = true);
		$$invalidate(3, unternehmensOpen = false);
	};

	const mouseleave_handler_1 = () => $$invalidate(4, studierendeOpen = false);
