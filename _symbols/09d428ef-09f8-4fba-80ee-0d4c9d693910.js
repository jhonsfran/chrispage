...
function create_each_block(ctx) {
	...
	let button;
	let span0;
	let t0_value = /*faq*/ ctx[5].question + "";
	let t0;
	let t1;
	let span1;
	let t2;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*faqs*/ 1 && t0_value !== (t0_value = /*faq*/ ctx[5].question + "")) set_data(t0, t0_value);
			if (dirty & /*faqs*/ 1 && t4_value !== (t4_value = /*faq*/ ctx[5].answer + "")) set_data(t4, t4_value);
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			div0 = element("div");
			span = element("span");
			t0 = text(/*badge_text*/ ctx[3]);
			t1 = space();
			h2 = element("h2");
			t2 = text(/*heading*/ ctx[1]);
			t3 = space();
			p = element("p");
			t4 = text(/*subheader*/ ctx[2]);
			t5 = space();
			div1 = element("div");
		...
		l(nodes) {
			...
			t0 = claim_text(span_nodes, /*badge_text*/ ctx[3]);
			...
			p = claim_element(div0_nodes, "P", { class: true });
			var p_nodes = children(p);
			t4 = claim_text(p_nodes, /*subheader*/ ctx[2]);
			p_nodes.forEach(detach);
			div0_nodes.forEach(detach);
		...
		p(ctx, [dirty]) {
			if (dirty & /*badge_text*/ 8) set_data(t0, /*badge_text*/ ctx[3]);
			if (dirty & /*heading*/ 2) set_data(t2, /*heading*/ ctx[1]);
			if (dirty & /*subheader*/ 4) set_data(t4, /*subheader*/ ctx[2]);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('subheader' in $$props) $$invalidate(2, subheader = $$props.subheader);
		if ('badge_text' in $$props) $$invalidate(3, badge_text = $$props.badge_text);
	};

	return [faqs, heading, subheader, badge_text, props];
}
