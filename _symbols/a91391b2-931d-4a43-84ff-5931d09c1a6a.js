...
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(img, "class", "intro-icon svelte-1azzj91");
			attr(img, "alt", "Logo");
		},
		m(target, anchor) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			if (!src_url_equal(img.src, img_src_value = /*logo*/ ctx[0].image.url)) attr(img, "src", img_src_value);
			attr(img, "class", "nav-icon svelte-1azzj91");
			attr(img, "alt", "Logo");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(div0, "class", "intro-content svelte-1azzj91");
			attr(div1, "class", "intro svelte-1azzj91");
			...
			attr(div5, "class", "nav-wrapper svelte-1azzj91");
			attr(header, "class", "header svelte-1azzj91");
			toggle_class(header, "active", /*introDone*/ ctx[2]);
			attr(div6, "class", "main-content svelte-1azzj91");
