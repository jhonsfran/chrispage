// Site Navigation not Homepage - Updated September 11, 2026
function noop() { }
...
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(img, "class", "nav-icon svelte-1jlx087");
			attr(img, "alt", "Logo");
		},
		m(target, anchor) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "class", "mobile-link svelte-1jlx087");
			attr(a0, "href", "/statistische-beratung-fuer-unternehmen");
			attr(a1, "class", "mobile-link svelte-1jlx087");
			attr(a1, "href", "/team");
			attr(a2, "class", "mobile-link svelte-1jlx087");
			attr(a2, "href", "/kontakt");
			attr(a3, "class", "mobile-link svelte-1jlx087");
			attr(a3, "href", "/statistik-beratung-fuer-studierende");
			attr(a4, "href", a4_href_value = /*primary_cta*/ ctx[1].url);
			attr(a4, "class", "mobile-button svelte-1jlx087");
			attr(div, "class", "mobile-menu svelte-1jlx087");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(a0, "click", /*click_handler_1*/ ctx[8]),
					listen(a1, "click", /*click_handler_2*/ ctx[9]),
					listen(a2, "click", /*click_handler_3*/ ctx[10]),
					listen(a3, "click", /*click_handler_4*/ ctx[11]),
					listen(a4, "click", /*click_handler_5*/ ctx[12])
				];
...
function create_fragment(ctx) {
	...
	let t8;
	let a4;
	let t9_value = /*primary_cta*/ ctx[1].label + "";
	let t9;
	let a4_href_value;
	let t10;
	let button;
	...
	let mounted;
	let dispose;
	let if_block0 = /*logo*/ ctx[0].image && /*logo*/ ctx[0].image.url && create_if_block_1(ctx);
	let if_block1 = /*menuOpen*/ ctx[2] && create_if_block(ctx);
	...
	return {
		...
		l(nodes) {
			...
			var a2_nodes = children(a2);
			t5 = claim_text(a2_nodes, "Kontakt");
			a2_nodes.forEach(detach);
			t6 = claim_space(div2_nodes);
			a3 = claim_element(div2_nodes, "A", { class: true, href: true });
			var a3_nodes = children(a3);
			t7 = claim_text(a3_nodes, "Für Studierende");
			a3_nodes.forEach(detach);
		...
		h() {
			attr(a0, "class", "link svelte-1jlx087");
			attr(a0, "href", "/statistische-beratung-fuer-unternehmen");
			attr(a1, "class", "link svelte-1jlx087");
			attr(a1, "href", "/team");
			attr(div0, "class", "nav-left svelte-1jlx087");
			attr(div1, "class", "nav-center svelte-1jlx087");
			attr(a2, "class", "link svelte-1jlx087");
			attr(a2, "href", "/kontakt");
			attr(a3, "class", "link svelte-1jlx087");
			attr(a3, "href", "/statistik-beratung-fuer-studierende");
			attr(a4, "href", a4_href_value = /*primary_cta*/ ctx[1].url);
			attr(a4, "class", "button svelte-1jlx087");
			attr(div2, "class", "nav-right svelte-1jlx087");
			attr(span0, "class", "svelte-1jlx087");
			toggle_class(span0, "open", /*menuOpen*/ ctx[2]);
			attr(span1, "class", "svelte-1jlx087");
			toggle_class(span1, "open", /*menuOpen*/ ctx[2]);
			attr(span2, "class", "svelte-1jlx087");
			toggle_class(span2, "open", /*menuOpen*/ ctx[2]);
			attr(button, "class", "hamburger svelte-1jlx087");
			attr(div3, "class", "nav-wrapper svelte-1jlx087");
			attr(header, "class", "header svelte-1jlx087");
			attr(div4, "class", "main-content svelte-1jlx087");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if ((!current || dirty & /*primary_cta*/ 2) && t9_value !== (t9_value = /*primary_cta*/ ctx[1].label + "")) set_data(t9, t9_value);

			if (!current || dirty & /*primary_cta*/ 2 && a4_href_value !== (a4_href_value = /*primary_cta*/ ctx[1].url)) {
				attr(a4, "href", a4_href_value);
			}

			if (!current || dirty & /*menuOpen*/ 4) {
				toggle_class(span0, "open", /*menuOpen*/ ctx[2]);
			}
...
function instance($$self, $$props, $$invalidate) {
	...
	let menuOpen = false;
	const click_handler = () => $$invalidate(2, menuOpen = !menuOpen);
	const click_handler_1 = () => $$invalidate(2, menuOpen = false);
	const click_handler_2 = () => $$invalidate(2, menuOpen = false);
	const click_handler_3 = () => $$invalidate(2, menuOpen = false);
	const click_handler_4 = () => $$invalidate(2, menuOpen = false);
	const click_handler_5 = () => $$invalidate(2, menuOpen = false);
