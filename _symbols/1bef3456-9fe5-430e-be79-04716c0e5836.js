...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(img, "class", "nav-icon svelte-2p8cy2");
			attr(img, "alt", "Logo");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "class", "link svelte-2p8cy2");
			attr(a0, "href", "/statistische-beratung-fuer-unternehmen");
			attr(a1, "class", "link svelte-2p8cy2");
			attr(a1, "href", "/team");
			attr(div0, "class", "nav-left svelte-2p8cy2");
			attr(div1, "class", "nav-center svelte-2p8cy2");
			attr(a2, "class", "link svelte-2p8cy2");
			attr(a2, "href", "/kontakt");
			attr(a3, "class", "link svelte-2p8cy2");
			attr(a3, "href", "/statistik-beratung-fuer-studierende");
			attr(a4, "href", a4_href_value = /*primary_cta*/ ctx[1].url);
			attr(a4, "class", "button svelte-2p8cy2");
			attr(div2, "class", "nav-right svelte-2p8cy2");
			attr(div3, "class", "nav-wrapper svelte-2p8cy2");
			attr(header, "class", "header svelte-2p8cy2");
			attr(div4, "class", "main-content svelte-2p8cy2");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [logo, primary_cta, props, site_nav, $$scope, slots];
}
