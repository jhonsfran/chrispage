// Landing Page Studis und Unternehmen - Updated September 10, 2026
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t4 = space();
			p = element("p");
			t5 = text("Datenanalyse, die überzeugt — verständlich, präzise und auf den Punkt.");
			this.h();
		},
		l(nodes) {
			...
			t5 = claim_text(p_nodes, "Datenanalyse, die überzeugt — verständlich, präzise und auf den Punkt.");
		...
		h() {
			...
			attr(canvas, "class", "svelte-eho3bh");
			attr(span0, "class", "heading-top svelte-eho3bh");
			attr(span1, "class", "heading-bottom svelte-eho3bh");
			attr(h1, "class", "heading svelte-eho3bh");
			attr(p, "id", "short_quote");
			attr(p, "class", "svelte-eho3bh");
			attr(div0, "class", "hero-text svelte-eho3bh");
			attr(div1, "class", "hero svelte-eho3bh");
			attr(div2, "class", "section-container svelte-eho3bh");
			attr(section, "class", "svelte-eho3bh");
		},
		m(target, anchor) {
...
class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 0, items: 1, heading: 2 });
	}
}
