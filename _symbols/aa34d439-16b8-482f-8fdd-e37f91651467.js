// New Hero block - Updated September 11, 2026
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t17 = claim_text(a_nodes, "Erstgespräch vereinbaren");
		...
		m(target, anchor) {
			...
			append_hydration(span4, t11);
			append_hydration(div0, t12);
			append_hydration(div0, span5);
			append_hydration(span5, t13);
			append_hydration(div0, t14);
			append_hydration(div0, span6);
			append_hydration(span6, t15);
