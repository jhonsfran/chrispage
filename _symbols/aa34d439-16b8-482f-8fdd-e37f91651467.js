...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			div1 = element("div");
			span4 = element("span");
			t12 = text("✓ Muster und Potenziale erkennen");
			t13 = space();
			span5 = element("span");
			t14 = text("✓ Automatisierte Reports & Dashboards");
			t15 = space();
			span6 = element("span");
			t16 = text("✓ Konkrete Handlungsempfehlungen");
			t17 = space();
			div4 = element("div");
			div3 = element("div");
			this.h();
		...
		l(nodes) {
			...
			t5 = claim_text(span2_nodes, "Daten verstehen.");
			...
			t12 = claim_text(span4_nodes, "✓ Muster und Potenziale erkennen");
			span4_nodes.forEach(detach);
			t13 = claim_space(div1_nodes);
			span5 = claim_element(div1_nodes, "SPAN", { class: true });
			var span5_nodes = children(span5);
			t14 = claim_text(span5_nodes, "✓ Automatisierte Reports & Dashboards");
			span5_nodes.forEach(detach);
			t15 = claim_space(div1_nodes);
			span6 = claim_element(div1_nodes, "SPAN", { class: true });
			var span6_nodes = children(span6);
			t16 = claim_text(span6_nodes, "✓ Konkrete Handlungsempfehlungen");
