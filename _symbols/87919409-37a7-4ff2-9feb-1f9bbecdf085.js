...
// (308:10) {#if item.image && item.image.url}
function create_if_block_3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(img, "class", "svelte-13conyg");
			attr(div, "class", "image-wrapper svelte-13conyg");
		},
		m(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "overlay-name svelte-13conyg");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			append_hydration(div, t);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "short-quote svelte-13conyg");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			append_hydration(div, t);
...
// (326:10) {#if item.long_quote && item.long_quote.html}
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "long-quote svelte-13conyg");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
...
// (332:10) {#if item.link && item.link.url}
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "more-link svelte-13conyg");
		},
		m(target, anchor) {
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "card svelte-13conyg");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(canvas, "class", "svelte-13conyg");
			attr(div0, "class", "chart-gradient");
			attr(h1, "class", "heading svelte-13conyg");
			attr(div1, "class", "cards svelte-13conyg");
			attr(div2, "class", "section-container svelte-13conyg");
			attr(section, "class", "svelte-13conyg");
		},
		m(target, anchor) {
