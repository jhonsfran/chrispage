// Landing Page Block - Updated April 16, 2026
function noop() { }
function run(fn) {
    return fn();
}
...
// (236:10) {#if item.image && item.image.url}
function create_if_block_3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(img, "class", "svelte-12rpdc5");
			attr(div, "class", "image-wrapper svelte-12rpdc5");
		},
		m(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "overlay-name svelte-12rpdc5");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			append_hydration(div, t);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "short-quote svelte-12rpdc5");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			append_hydration(div, t);
...
// (257:10) {#if item.long_quote && item.long_quote.html}
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "long-quote svelte-12rpdc5");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
...
// (264:10) {#if item.link && item.link.url}
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "more-link svelte-12rpdc5");
		},
		m(target, anchor) {
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "card svelte-12rpdc5");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", "heading svelte-12rpdc5");
			attr(div0, "class", "cards svelte-12rpdc5");
			attr(div1, "class", "section-container svelte-12rpdc5");
			attr(section, "class", "svelte-12rpdc5");
		},
		m(target, anchor) {
