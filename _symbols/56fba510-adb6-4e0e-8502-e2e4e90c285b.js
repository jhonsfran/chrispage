// Trainer und Referenzen - Updated September 22, 2026
function noop() { }
function run(fn) {
    return fn();
}
...
// (269:6) {#if speaker_image && speaker_image.url}
...
function create_if_block_8(ctx) {
	...
	return {
		...
		h() {
			attr(p, "class", "cg-dl-trainer__eyebrow svelte-t30itk");
		},
		m(target, anchor) {
...
function create_if_block_7(ctx) {
	...
	return {
		...
		h() {
			attr(p, "class", "cg-dl-trainer__lead svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, p, anchor);
			append_hydration(p, t);
...
function create_if_block_6(ctx) {
	...
	return {
		...
		h() {
			attr(p, "class", "cg-dl-trainer__description svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, p, anchor);
			append_hydration(p, t);
...
function create_if_block_4(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "cg-dl-trainer__facts svelte-t30itk");
		},
		m(target, anchor) {
...
// (302:10) {#each facts as fact}
function create_each_block_1(ctx) {
	let div;
	let strong;
	let t0_value = /*fact*/ ctx[15].title + "";
	let t0;
	let t1;
	let t2;
	let if_block = /*fact*/ ctx[15].text && create_if_block_5(ctx);
	...
	return {
		...
		h() {
			attr(strong, "class", "svelte-t30itk");
			attr(div, "class", "svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h() {
			attr(p, "class", "cg-dl-trainer__references-heading svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, p, anchor);
			append_hydration(p, t);
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(p, "class", "cg-dl-trainer__references-text svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, p, anchor);
			append_hydration(p, t);
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "cg-dl-trainer__logos svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
...
function create_else_block(ctx) {
	let span;
	let t_value = (/*item*/ ctx[12].name || "LOGO") + "";
	let t;
...
// (332:14) {#if item.logo && item.logo.url}
function create_if_block_1(ctx) {
	...
	return {
		...
		h() {
			if (!src_url_equal(img.src, img_src_value = /*item*/ ctx[12].logo.url)) attr(img, "src", img_src_value);
			attr(img, "alt", img_alt_value = /*item*/ ctx[12].logo.alt || /*item*/ ctx[12].name || "Referenzlogo");
			attr(img, "class", "svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, img, anchor);
...
// (330:10) {#each logos as item}
function create_each_block(ctx) {
	let div;
	let t;

	function select_block_type(ctx, dirty) {
		if (/*item*/ ctx[12].logo && /*item*/ ctx[12].logo.url) return create_if_block_1;
	...
	return {
		...
		h() {
			attr(div, "class", "cg-dl-trainer__logo svelte-t30itk");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			if_block.m(div, null);
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			if (if_block5) if_block5.l(aside_nodes);
			t7 = claim_space(aside_nodes);
			if (if_block6) if_block6.l(aside_nodes);
			t8 = claim_space(aside_nodes);
			if (if_block7) if_block7.l(aside_nodes);
		...
		h() {
			attr(div0, "class", "cg-dl-trainer__image cg-reveal-item svelte-t30itk");
			attr(h2, "id", "cg-dl-trainer-heading");
			attr(h2, "class", "svelte-t30itk");
			attr(div1, "class", "cg-dl-trainer__content cg-reveal-item svelte-t30itk");
			attr(aside, "class", "cg-dl-trainer__references cg-reveal-item svelte-t30itk");
			attr(div2, "class", "cg-dl-trainer__inner svelte-t30itk");
			attr(section, "class", "cg-dl-trainer svelte-t30itk");
		...
		m(target, anchor) {
			...
			append_hydration(aside, t7);
			if (if_block6) if_block6.m(aside, null);
			append_hydration(aside, t8);
			if (if_block7) if_block7.m(aside, null);
